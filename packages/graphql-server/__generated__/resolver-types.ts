...
import type { Campaign, User } from '../../database/__generated__/prisma/index.d.js';
import type { ArchivistGraphQLContext } from '../src/context';
export type RequireFields<T, K extends keyof T> = Omit<T, K> & { [P in K]-?: NonNullable<T[P]> };


export type ResolverTypeWrapper<T> = Promise<T> | T | import('../../database/__generated__/prisma').PrismaPromise<T>;
